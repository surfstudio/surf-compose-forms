...
/**
 * Converts a given string codes representation to emoji (🧑), also for complex (🧑🏻‍🏭)
 */
private fun convertToCharSequence(raw: String): String {
    return raw.splitToSequence(" ").map { hexStr ->
        val hexInt = Integer.parseInt(hexStr, 16)
        val chars = Character.toChars(hexInt)
        String(chars)
    }.joinToString("")
}